<script setup>
    ...
    const fetchUserInfo = async () => {
        const response = await fetch('https://seng513projectdeploy.onrender.com/viewProfile/', {
            method: 'POST',
            headers: {
    ...
    const fetchTopGames = async() => {
        const response = await fetch('https://seng513projectdeploy.onrender.com/user/topGames?username='+profileUsername.value);
            ...
            <ul>
                <li v-for="game in topGames" :key="game.id">
                    <div class="topGamesImage">
                        <img :src="'https://seng513projectdeploy.onrender.com' + game.thumbnail" alt="Image Unavailable" id ="marioIcon">
                    </div>
