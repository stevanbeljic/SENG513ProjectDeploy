...
<script>
    ...
    export default {
        ...
        mounted(){
                let route = "https://seng513projectdeploy.onrender.com/game/getAllGames";
    ...
    <div class="page-container">
        ...
        <div id="games-container">
            ...
            <div v-for="item in filteredGames" :key="item.id" class="newsItem" v-on:click=handleClick(item.id)>
                <!-- <a href={{ }}> -->
                    <img :src="'https://seng513projectdeploy.onrender.com' + item.thumbnail" alt="Image Unavailable"/>
                    <p>{{ item.name }}</p>
