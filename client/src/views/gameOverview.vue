...
<script>
    ...
    const updateSessionData = async () => {
        ...
        const response = await fetch("https://seng513projectdeploy.onrender.com/game/existsTopGame?userid="+loggedInId.value+"&gameid="+route.params.id, {method: "GET"});
    ...
    export default {
        ...
        mounted() {
            ...
            let bRoute = "https://seng513projectdeploy.onrender.com/game/getGameById?id="+ this.$route.params.id; 
            fetch(bRoute, {method: "GET"})
            .then(res => res.json())
            .then(data => this.game = data[0])
            .catch(err => console.log(err.message));

            fetch("https://seng513projectdeploy.onrender.com/discussion/getDiscussionsByGame?id="+ this.$route.params.id, {method: "GET"})
            .then(res => res.json())
        ...
        methods: {
            ...
            addToTopGames: async function(gameid){
                const response = await fetch("https://seng513projectdeploy.onrender.com/game/addTopGame?userid="+loggedInId.value+"&gameid="+gameid, {method: "POST"});
                if (response.status == 200){
                    alert("Added game");
...
<template>
    ...
    <div class="body-container">
        <div class="game-overview">
            <div id="cover-image">
                <img :src="'https://seng513projectdeploy.onrender.com' + game.thumbnail" alt="Image Unavailable"/>
            </div>
